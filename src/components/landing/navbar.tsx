      ...
      <div className="max-w-6xl mx-auto px-8 h-16 relative flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="text-muted-foreground hover:text-foreground transition-colors p-1.5 border border-transparent hover:border-border rounded-md relative h-8 w-8 flex items-center justify-center"
